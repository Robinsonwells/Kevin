    ...
    <section id="properties" className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-light mb-4">Featured Properties</h2>
          ...
          {properties.map((property) => (
            ...
            >
              <div className="relative h-64 overflow-hidden">
                ...
                />
                <div className="absolute top-4 right-4 bg-amber-600 text-white px-4 py-2 rounded-lg font-semibold">
                  {property.price}
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <button className="w-full mt-6 bg-gray-900 hover:bg-amber-600 text-white py-3 rounded-lg transition-colors font-medium">
                  View Details
                </button>
              </div>
            </div>
